		...
		<div class="dt_header-navwrapper">
			<div class="dt_header-navwrapperinner">
				...
				<div class="dt_navbar dt-d-none dt-d-lg-block">
					<div class="dt_navbar-wrapper <?php if($softme_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','cozysoft'); endif; ?>">
				...
				<div class="dt_mobilenav <?php if($softme_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','cozysoft'); endif; ?> dt-d-lg-none">
					<div class="dt_mobilenav-topbar">
						...
						<div class="dt_mobilenav-topbar-content">
							<div class="dt-container">
								<div class="dt-row">
									<div class="dt-col-12">
										<?php do_action('cozysoft_site_header'); ?>
									</div>
								</div>
							</div>
						</div>
