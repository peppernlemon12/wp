...
( function( api ) {
	...
	// Extends our custom "softme" section.
	api.sectionConstructor['softme'] = api.Section.extend( {
...
jQuery(document).ready(function($) {
	 jQuery("#sub-accordion-section-softme_sidebar_options select:not(#_customize-input-softme_default_pg_sidebar_option), #sub-accordion-section-softme_typography_options select, #sub-accordion-section-softme_headings_typography select").prop('disabled', true);
});