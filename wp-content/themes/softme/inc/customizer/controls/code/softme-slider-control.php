 ...
 * @access public
 */
class SoftMe_Customizer_Range_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script(
			'softme-controls',
			SOFTME_THEME_INC_URI . '/customizer/controls/js/controls.js',
			array(
				'jquery',
				'customize-base',
				'jquery-ui-button',
		...
		wp_enqueue_style( 'softme-controls', SOFTME_THEME_INC_URI . '/customizer/controls/css/controls.css' );
		wp_enqueue_style( 'font-awesome', SOFTME_THEME_URI . '/assets/vendors/css/all.css' );
	}

	/**
	 * SoftMe_Customizer_Range_Control constructor.
	 *
 ...
 */
function softme_sanitize_range_value( $input ) {
	if ( softme_is_json( $input ) ) {
 ...
 * @param  string $string Input.
 */
function softme_is_json( $string ) {
	return is_string( $string ) && is_array( json_decode( $string, true ) ) ? true : false;
}
