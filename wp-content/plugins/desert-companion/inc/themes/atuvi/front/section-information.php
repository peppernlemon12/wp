...
?>
<section id="dt_service_one" class="dt_service dt_service--thirteen dt-py-default front-info">
	<div class="dt-container">
		<div class="dt-row">
			...
			?>
				<div class="dt-col-lg-4 dt-col-md-4 dt-col-sm-6 dt-col-12">
					<div class="dt_item_inner wow slideInUp animated" data-wow-delay="<?php echo esc_attr($i*100); ?>ms" data-wow-duration="1500ms">
						...
						<div class="dt_item_holder">
							...
							<?php if ( ! empty( $link ) ) : ?>
								<div class="dt_item_readmore dt-mt-3"><a class="dt-btn-plustext" href="<?php echo esc_url($link); ?>"><span>Read more</span></a></div>
							<?php endif; ?>									
						</div>
					</div>
				</div>
