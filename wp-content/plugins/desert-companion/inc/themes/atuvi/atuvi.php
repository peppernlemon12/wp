...
require desert_companion_plugin_dir . 'inc/themes/atua/front/site-header.php';

if ( ! function_exists( 'desert_companion_atua_frontpage_sections' ) ) :
	function desert_companion_atua_frontpage_sections() {	
		require desert_companion_plugin_dir . 'inc/themes/atua/front/section-slider.php';
		require desert_companion_plugin_dir . 'inc/themes/atuvi/front/section-information.php';
		require desert_companion_plugin_dir . 'inc/themes/atua/front/section-about.php';
		require desert_companion_plugin_dir . 'inc/themes/atuvi/front/section-service.php';
