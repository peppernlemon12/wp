<?php
function cosmobit_information5_customize_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	/*=========================================
	Information  Section
	=========================================*/
	$wp_customize->add_section(
		'information5_options', array(
	...
	=========================================*/
	$wp_customize->add_setting(
		'cosmobit_information5_content_options'
			,array(
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'cosmobit_sanitize_text',
			'priority' => 4,
	...
	'cosmobit_information5_content_options',
		...
		// Information 
		$wp_customize->add_setting( 'cosmobit_information7_option', 
			array(
			 'sanitize_callback' => 'cosmobit_repeater_sanitize',
			 'priority' => 5,
			  'default' => cosmobit_information7_options_default()
			)
		);
		
		$wp_customize->add_control( 
			new Cosmobit_Repeater( $wp_customize, 
				'cosmobit_information7_option', 
					array(
...
add_action( 'customize_register', 'cosmobit_information5_customize_setting' );