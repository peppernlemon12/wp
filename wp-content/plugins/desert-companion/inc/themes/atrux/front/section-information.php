...
?>
<section id="dt_service_one" class="dt_service dt_service--eleven dt-py-default front-info">
				...
				<div class="dt-row dt-g-4">
					...
					<div class="dt-col-lg-3 dt-col-md-6 dt-col-12">
						<div class="dt_item_inner wow slideInUp animated" data-wow-delay="<?php echo esc_attr($i*100); ?>ms" data-wow-duration="1500ms">
							...
							<div class="dt_item_hover" <?php if ( ! empty( $image ) ) : ?>style="background-image: url(<?php echo esc_url($image); ?>);"<?php endif; ?>>
