<?php
function atua_information_customize_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_setting(
		'atua_information_options_setting'
			,array(
	...
	// Hide/Show Setting
	$wp_customize->add_setting(
		'atua_information_options_hide_show'
			,array(
			'default'     	=> '1',
			'capability'     	=> 'edit_theme_options',
	...
	// Information 
		$wp_customize->add_setting( 'atua_information_option', 
			array(
			 'sanitize_callback' => 'atua_repeater_sanitize',
			 'priority' => 5,
			  'default' => atua_information_options_default()
			)
		);
	...
	// Upgrade
	$wp_customize->add_setting(
	'atua_information_option_upsale', 
	array(
		'capability' => 'edit_theme_options',
	...
	$wp_customize->add_control( 
		...
		($wp_customize, 
			'atua_information_option_upsale', 
			array(
				'label'      => __( 'Info', 'desert-companion' ),
				'section'    => 'information_options'
			) 
		) 
	);			
}
add_action( 'customize_register', 'atua_information_customize_setting' );