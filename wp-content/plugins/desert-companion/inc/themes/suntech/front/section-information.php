...
$softme_information_option 		= get_theme_mod('softme_information_option3',softme_information_options3_default());
if($softme_information_options_hide_show=='1'):
?>
<section id="dt_service_one" class="dt_service dt_service--seven dt-py-default front-info">
					...
					<div class="dt_item_inner wow slideInUp animated" data-wow-delay="<?php echo esc_attr($i*100); ?>ms" data-wow-duration="1500ms">
						<div class="dt_flipbox">						
							<div class="dt_item_holder">
								...
								<?php if ( ! empty( $title ) ) : ?>
									<h5 class="dt_item_title"><?php echo wp_kses( html_entity_decode( $title ), $allowed_html ); ?></h5>
								<?php endif; ?>
								
								<?php if ( ! empty( $link ) ) : ?>
									<a class="dt-btn-plus" href="<?php echo esc_url($link); ?>"><i class="fas fa-plus"></i></a>
								<?php endif; ?>	
							</div>
							...
							<?php if ( ! empty( $icon ) ) : ?>
								...
								<?php if ( ! empty( $link ) ) : ?>
									<a class="dt-btn-plus" href="<?php echo esc_url($link); ?>"><i class="fas fa-minus"></i></a>
								<?php endif; ?>	
							</div>
						</div>
					</div>
