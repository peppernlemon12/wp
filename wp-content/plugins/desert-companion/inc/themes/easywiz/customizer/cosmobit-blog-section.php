<?php
function cosmobit_blog5_customize_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	=========================================*/
	$wp_customize->add_setting(
		'cosmobit_blog5_content_options'
			,array(
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'cosmobit_sanitize_text',
			'priority' => 4,
	...
	if ( class_exists( 'Cosmobit_Customizer_Range_Control' ) ) {
		...
		$wp_customize->add_control( 
		new Cosmobit_Customizer_Range_Control( $wp_customize, 'cosmobit_blog5_num', 
			array(
...
add_action( 'customize_register', 'cosmobit_blog5_customize_setting' );