...
?>
<section id="dt_service_one" class="dt_service dt_service--six dt-py-default front-info">
				...
				<div class="dt-col-lg-3 dt-col-md-6 dt-col-12">
					<div class="dt_item_inner wow slideInUp animated" data-wow-delay="<?php echo esc_attr($i*100); ?>ms" data-wow-duration="1500ms">
						<div class="num-icon-wrap">
							<h2 class="number">0<?php echo esc_html($i+1); ?></h2>
							<?php if ( ! empty( $icon ) ) : ?>
						...
						<?php if ( ! empty( $image ) ) : ?>
							<div class="dt_item_image">
								<a href="#">
									<img src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" />
								</a>
							</div>
						<?php endif; ?>
					</div>
