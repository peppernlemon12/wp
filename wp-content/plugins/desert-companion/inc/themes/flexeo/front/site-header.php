...
$atua_hs_hdr_left_text 	= get_theme_mod( 'atua_hs_hdr_left_text','1'); 
$atua_hdr_left_text 	= get_theme_mod( 'atua_hdr_left_text','Welcome to our <a href="#">Flexeo</a> Service!');
		...
		<div class="dt-container">
			<div class="dt-row">
				<div class="dt-col-lg-6 dt-col-12">
					<?php if($atua_hs_hdr_left_text=='1'): ?>
						<div class="widget--left dt-text-lg-left">
							<p class="dt-mb-0 left-text"><?php echo wp_kses_post($atua_hdr_left_text); ?></p>
						</div>
					<?php endif; ?>		
				</div>
				<div class="dt-col-lg-6 dt-col-12">
