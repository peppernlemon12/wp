									...
									<div class="dt-col-lg-12 dt-col-md-12 first dt-my-auto">
										<div class="dt_slider-content">
											...
											<?php if ( ! empty( $subtitle2 ) && ! empty( $subtitle3 )) : ?>
												<h2 class="title"><span class="dt_slider-animate"><?php echo esc_html($subtitle2); ?></span><span class="dt_slider-animate text-primary"><?php echo esc_html($subtitle3); ?></span></h2>
											<?php endif; ?>	
