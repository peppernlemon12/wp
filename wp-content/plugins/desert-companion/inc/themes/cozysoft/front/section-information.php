...
$softme_information_option 		= get_theme_mod('softme_information_option2',softme_information_options2_default());
if($softme_information_options_hide_show=='1'):
?>
<section id="dt_service_one" class="dt_service dt_service--four dt-py-default front-info">
	<div class="dt-container">
		<div class="dt-row dt-g-4 info-wrp">
			...
			?>
				<div class="dt-col-lg-2 dt-col-md-6 dt-col-12">
