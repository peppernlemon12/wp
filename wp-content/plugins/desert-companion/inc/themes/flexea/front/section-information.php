			...
			<div class="dt-col-lg-12 dt-col-md-12 dt-col-12 dt_service_row-no">
				<div class="dt-row dt-g-4">
					...
					<div class="dt-col-lg-3 dt-col-md-6 dt-col-12">
						<div class="dt_item_inner wow slideInUp animated" style="<?php if ( ! empty( $image ) ) : ?>background-image: url(<?php echo esc_url($image); ?>);<?php endif; ?>" data-wow-delay="<?php echo esc_attr($i*100); ?>ms" data-wow-duration="1500ms">
							<?php if ( ! empty( $icon ) ) : ?>
							...
							<div class="dt_item_holder">
								...
								<h2 class="number"><?php echo esc_html( str_pad($i+1, 2, '0', STR_PAD_LEFT) ); ?></h2>								
							</div>
