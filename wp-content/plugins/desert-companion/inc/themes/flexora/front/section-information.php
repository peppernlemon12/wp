<?php  
	...
	$cosmobit_information3_text		= get_theme_mod('cosmobit_information3_text','The majority have suffered alteration in some form, by cted ipsum dolor sit amet, consectetur adipisicing elit.'); 
...
?>	
<section id="information3_options" class="dt__infoservices dt__infoservices--three front3--info">
					...
					<div class="dt__infoservices-block">
						<div class="dt__infoservices-inner">
							...
							<?php if ( ! empty( $button ) ) : ?>
								...
								<div class="link-btn"><a href="<?php echo esc_url($link); ?>" class="more-link dt-btn dt-btn-primary"><?php echo esc_html($button); ?> <i class="fa fa-arrow-right"></i></a></div>
							<?php endif; ?>
						</div>
					</div>
				</div>
