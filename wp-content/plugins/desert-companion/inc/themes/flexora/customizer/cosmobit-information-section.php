<?php
function cosmobit_information3_customize_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	/*=========================================
	Information  Section
	=========================================*/
	$wp_customize->add_section(
		'information3_options', array(
	...
	=========================================*/
	$wp_customize->add_setting(
		'cosmobit_information3_content_options'
			,array(
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'cosmobit_sanitize_text',
			'priority' => 4,
	...
	// Information 
		$wp_customize->add_setting( 'cosmobit_information3_option', 
			array(
			 'sanitize_callback' => 'cosmobit_repeater_sanitize',
			 'priority' => 5,
			  'default' => cosmobit_information3_options_default()
			)
		);
...
add_action( 'customize_register', 'cosmobit_information3_customize_setting' );