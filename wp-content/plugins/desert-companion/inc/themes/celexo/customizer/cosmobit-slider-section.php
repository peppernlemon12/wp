<?php
function cosmobit_slider2_customize_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	/*=========================================
	Slider Section Panel
	=========================================*/
	$wp_customize->add_panel(
		'cosmobit_frontpage2_options', array(
			'priority' => 32,
	...
	// Slider 
		$wp_customize->add_setting( 'cosmobit_slider2_option', 
			array(
			 'sanitize_callback' => 'cosmobit_repeater_sanitize',
			 'priority' => 5,
			  'default' => cosmobit_slider2_options_default()
			)
		);
		
		$wp_customize->add_control( 
			new Cosmobit_Repeater( $wp_customize, 
				'cosmobit_slider2_option', 
					array(
	...
	if ( class_exists( 'Cosmobit_Customizer_Range_Control' ) ) {
		...
		$wp_customize->add_control( 
		new Cosmobit_Customizer_Range_Control( $wp_customize, 'cosmobit_slider2_opacity', 
			array(
...
add_action( 'customize_register', 'cosmobit_slider2_customize_setting' );